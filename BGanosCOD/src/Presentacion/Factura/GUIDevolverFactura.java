	...
	*/
		...
		botonAceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(GUIDevolverFactura.this, "Los datos no son correctos", "Error",
	...
	public void actualizar(Context context) {
		...
		if (context.getEvento() == Evento.DEVOLVER_FACTURA_OK) {
			...
			JOptionPane.showMessageDialog(this, "Factura devuelta correctamente", "Éxito",
