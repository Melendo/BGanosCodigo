	...
	*/
	...
	public void initGUI() {
		...
		JLabel msgIntroIDCabecera = ComponentsBuilder
				.createLabel("Introduzca el ID de la Factura que quiere modificar ", 1, 10, 80, 20, Color.BLACK);
		...
		JLabel labelFechaCompraHelper = ComponentsBuilder.createLabel("Formato: dd/MM/yyyy", 10, 100, 200, 20,
				Color.BLACK);
		...
		botonAceptar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					JOptionPane.showMessageDialog(GUIModificarFactura.this, "Los datos no son correctos", "Error",
	...
	public void actualizar(Context context) {
		...
		if (context.getEvento() == Evento.MODIFICAR_FACTURA_OK) {
			...
			JOptionPane.showMessageDialog(this, "Factura modificar correctamente la factura con id " + resultado,
			...
			case -2:
				...
				break;
			default:
				JOptionPane.showMessageDialog(this, "Error desconocido al modificar la factura.", "Error",
						JOptionPane.ERROR_MESSAGE);
				break;
			}
		}
