	...
	public void iniGUI() {
		...
		buttonAltaInvernadero.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.ALTA_INVERNADERO_VISTA, invernadero));
			}
		});
		...
		buttonBajaInvernadero.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUIInvernadero.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.BAJA_INVERNADERO_VISTA, invernadero));
			}
		});
		...
		buttonModificarInvernadero.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUIInvernadero.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.MODIFICAR_INVERNADERO_VISTA, invernadero));
			}
		});
		...
		buttonMostrarInvernaderoPorID.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUIInvernadero.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.MOSTRAR_INVERNADERO_POR_ID_VISTA, invernadero));
			}
		});
		...
		buttonListarInvernaderoPorSistemasRiego.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUIInvernadero.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.LISTAR_INVERNADEROS_POR_SISTEMA_RIEGO_VISTA, invernadero));
			}
		});
		...
		buttonVincularSistemasRiegoAInvernadero = ComponentsBuilder.createButton("Vincular a un SR", 500, 250, 185,
				100);
		buttonVincularSistemasRiegoAInvernadero.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUIInvernadero.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.VINCULAR_SISTEMA_RIEGO_INVERNADERO_VISTA, invernadero));
			}
		});
		...
		buttonDesincularSistemasRiegoAInvernadero = ComponentsBuilder.createButton("Desvincular de un SR", 700, 250,
				185, 100);
		buttonDesincularSistemasRiegoAInvernadero.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUIInvernadero.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.DESVINCULAR_SISTEMA_RIEGO_INVERNADERO_VISTA, invernadero));
			}
		});
		...
		buttonDesincularSistemasRiegoAInvernadero = ComponentsBuilder.createButton("3 Fechas Más Vendidas", 400, 400,
				185, 100);
		buttonDesincularSistemasRiegoAInvernadero.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				...
				ApplicationController.getInstance().manageRequest(
						new Context(Evento.CALCULAR_LAS_3_FECHAS_MAS_VENDIDAS_DE_UN_INVERNADERO_VISTA, invernadero));
			}
		});
		buttonDesincularSistemasRiegoAInvernadero.setVisible(true);
		this.add(buttonDesincularSistemasRiegoAInvernadero);
