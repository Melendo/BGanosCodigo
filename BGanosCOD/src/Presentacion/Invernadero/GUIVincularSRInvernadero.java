...
public class GUIVincularSRInvernadero extends JFrame implements IGUI {
	...
	public GUIVincularSRInvernadero() {
		super("Vincular Sistema de Riego a Invernadero");
	...
	public void iniGUI() {
		...
		botonCancelar.addActionListener(new ActionListener() {
			@Override
			public void actionPerformed(ActionEvent e) {
				GUIVincularSRInvernadero.this.setVisible(false);
		...
		if (context.getEvento() == Evento.VINCULAR_SISTEMA_RIEGO_A_INVERNADERO_OK) {
			...
			case -5:
				JOptionPane.showMessageDialog(this,
						"Error: El Invernadero Y el Sistemad de Riego ya se encuentran vinculados.", "Error",
						JOptionPane.ERROR_MESSAGE);
				break;
			}
		}
