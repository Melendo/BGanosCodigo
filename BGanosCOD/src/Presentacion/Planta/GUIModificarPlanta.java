			...
			public void actionPerformed(ActionEvent e) {
				...
				try {
					...
					if (planta instanceof TPlantaFrutal) {
						...
						if (((TPlantaFrutal) planta).get_maduracion().isEmpty()
								|| ((TPlantaFrutal) planta).get_nombre_fruta().isEmpty()
							...
							ApplicationController.getInstance()
									.manageRequest(new Context(Evento.MODIFICAR_PLANTA, planta));
							setVisible(false);
						}
						...
						if (((TPlantaNoFrutal) planta).get_tipo_hoja().isEmpty() || planta.get_nombre().isEmpty()
								|| planta.get_nombre_cientifico().isEmpty()) {
							GUIMSG.showMessage("Rellene los campos", "MODIFICAR PLANTA", true);
						} else {
