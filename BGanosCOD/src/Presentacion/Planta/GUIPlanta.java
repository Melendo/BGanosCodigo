	...
	public void initGUI() {
		...
		bMostrarPlantaPorId.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.MOSTRAR_PLANTA_POR_ID_VISTA, null));
			}
		});
		...
		bListarPlantasPorTipo.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				//	GUIPlanta.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.LISTAR_PLANTAS_POR_TIPO_VISTA, null));
			}
		});
		...
		bListarPlantasPorInvernadero = ComponentsBuilder.createButton("Listar Plantas Por Invernadero", 125, 400, 225,
				100);
		bListarPlantasPorInvernadero.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				//GUIPlanta.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.LISTAR_PLANTAS_INVERNADERO_VISTA, null));
			}
		});
