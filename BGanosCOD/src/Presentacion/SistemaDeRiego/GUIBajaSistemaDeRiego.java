	...
	*/
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ApplicationController.getInstance()
							.manageRequest(new Context(Evento.BAJA_SISTEMA_RIEGO, idSistema));
				} catch (NumberFormatException ex) {
					JOptionPane.showMessageDialog(GUIBajaSistemaDeRiego.this, "Error en el formato del ID", "Error",
	...
	public void actualizar(Context context) {
		...
		if (context.getEvento() == Evento.BAJA_SISTEMA_DE_RIEGO_OK) {
			...
			JOptionPane.showMessageDialog(this, "Sistema de riego " + resultado + " dado de baja correctamente",
					"Éxito", JOptionPane.INFORMATION_MESSAGE);
		} else if (context.getEvento() == Evento.BAJA_SISTEMA_DE_RIEGO_KO) {

			switch (resultado) {
			case -2:
				JOptionPane.showMessageDialog(this, "Error: El sistema de riego ya esta dado de baja.", "Error",
						JOptionPane.ERROR_MESSAGE);
				break;
			case -404:
				JOptionPane.showMessageDialog(this, "Error: El sistema de riego especificado no existe.", "Error",
						JOptionPane.ERROR_MESSAGE);
				break;
			default:
