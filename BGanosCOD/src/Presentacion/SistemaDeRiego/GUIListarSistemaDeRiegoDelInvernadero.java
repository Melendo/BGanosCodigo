	...
	*/
	...
	private void buscarPorInvernadero() {
		...
		try {
			...
			ApplicationController.getInstance()
					.manageRequest(new Context(Evento.LISTAR_SISTEMAS_RIEGO_DE_INVERNADERO, idInvernadero));
		} catch (NumberFormatException ex) {
			JOptionPane.showMessageDialog(this, "Por favor, ingrese un número válido para el ID del invernadero.",
	...
	public void actualizar(Context context) {
		if (context.getEvento() == Evento.LISTAR_SISTEMA_DE_RIEGO_DE_INVERNADERO_OK) {
			...
			JOptionPane.showMessageDialog(this, "Error al listar sistemas de riego del invernadero.", "Error",
