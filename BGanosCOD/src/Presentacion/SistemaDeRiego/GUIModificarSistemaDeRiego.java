...
public class GUIModificarSistemaDeRiego extends JFrame implements IGUI {
	...
	* @generated "UML a JPA (com.ibm.xtools.transform.uml2.ejb3.java.jpa.internal.UML2JPATransform)"
	*/
	public void initGUI(TSistemaDeRiego... sistemaDeRiego) {
		// begin-user-code
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ApplicationController.getInstance()
							.manageRequest(new Context(Evento.MODIFICAR_SISTEMA_RIEGO, sistemaDeRiego));
				} catch (NumberFormatException ex) {
					JOptionPane.showMessageDialog(GUIModificarSistemaDeRiego.this, "Error en el formato de los datos",
	...
	public void actualizar(Context context) {
		...
		if (context.getEvento() == Evento.MODIFICAR_SISTEMA_DE_RIEGO_OK) {
			JOptionPane.showMessageDialog(this, "Sistema de riego " + resultado + " modificado correctamente", "Éxito",
			...
			case -2:
				JOptionPane.showMessageDialog(this,
						"Error: Ya existe un sistema de riego con el mismo nombre y está activo.", "Error",
						JOptionPane.ERROR_MESSAGE);
				break;
			case -511:
				JOptionPane.showMessageDialog(this, "Error: El fabricante asociado no está activo.", "Error",
						JOptionPane.ERROR_MESSAGE);
				break;
			case -404:
				JOptionPane.showMessageDialog(this, "Error: El fabricante especificado no existe.", "Error",
						JOptionPane.ERROR_MESSAGE);
				break;
			default:
