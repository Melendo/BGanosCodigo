	...
	*/
			...
			public void actionPerformed(ActionEvent e) {
				try {
					...
					ApplicationController.getInstance()
							.manageRequest(new Context(Evento.MOSTRAR_SISTEMA_RIEGO_POR_ID, idSistema));
				} catch (NumberFormatException ex) {
					JOptionPane.showMessageDialog(GUIMostrarSistemaDeRiegoPorID.this, "Error en el formato del ID",
	...
	public void actualizar(Context context) {
		...
		if (context.getEvento() == Evento.MOSTRAR_SISTEMA_DE_RIEGO_OK) {
			...
			String texto = "ID: " + sistemaRiego.getId() + ", Nombre: " + sistemaRiego.getNombre()
					+ ", Potencia de Riego: " + sistemaRiego.getPotenciaRiego() + ", Cantidad de Agua: "
					+ sistemaRiego.getCantidad_agua() + ", Frecuencia: " + sistemaRiego.getFrecuencia() + ", Activo: "
					+ (sistemaRiego.getActivo() ? "Si" : "No") + ", Fabricante: " + sistemaRiego.getIdFabricante();
			...
			JOptionPane.showMessageDialog(this,
					"No existe sistema de riego con ID: " + ((TSistemaDeRiego) context.getDatos()).getId(), "Error",
