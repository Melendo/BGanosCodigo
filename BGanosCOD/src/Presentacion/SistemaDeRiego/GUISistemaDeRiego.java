	...
	public void initGUI() {
		...
		buttonAltaSistemaRiego.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.ALTA_SISTEMA_RIEGO_VISTA, tSistemaRiego));
			}
		});
		...
		buttonBajaSistemaRiego.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUISistemaDeRiego.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.BAJA_SISTEMA_RIEGO_VISTA, tSistemaRiego));
			}
		});
		...
		buttonModificarSistemaRiego.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUISistemaDeRiego.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.MODIFICAR_SISTEMA_RIEGO_VISTA, tSistemaRiego));
			}
		});
		...
		buttonMostrarSistemaRiego.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUISistemaDeRiego.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.MOSTRAR_SISTEMA_RIEGO_POR_ID_VISTA, tSistemaRiego));
			}
		});
		...
		buttonListarSistemasRiego.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUISistemaDeRiego.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.LISTAR_SISTEMAS_RIEGO, tSistemaRiego));
			}
		});
		...
		buttonListarSistemasRiegoPorFabricante = ComponentsBuilder.createButton("Listar por Fabricante", 500, 250, 185,
				100);
		buttonListarSistemasRiegoPorFabricante.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUISistemaDeRiego.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.LISTAR_SISTEMAS_RIEGO_POR_FABRICANTE_VISTA, tSistemaRiego));
			}
		});
		...
		buttonListarSistemasRiegoEnInvernadero = ComponentsBuilder.createButton("Listar en invernadero", 300, 250, 185,
				100);
		buttonListarSistemasRiegoEnInvernadero.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				GUISistemaDeRiego.this.setVisible(false);
				ApplicationController.getInstance()
						.manageRequest(new Context(Evento.LISTAR_SISTEMAS_RIEGO_INVERNADERO_VISTA, tSistemaRiego));
			}
		});
